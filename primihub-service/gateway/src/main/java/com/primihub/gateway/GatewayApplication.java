...
@ComponentScan(
    ...
    excludeFilters = {
        @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = {GrpcServerConfiguration.class,SingleTaskChannelConsumer.class, SysFusionService.class , ThreadPoolConfig.class}),
        @ComponentScan.Filter(type = FilterType.REGEX, pattern = {"com.primihub.biz.service.data.*","com.primihub.biz.service.schedule.*","com.primihub.biz.service.test.*"})
    }
)
