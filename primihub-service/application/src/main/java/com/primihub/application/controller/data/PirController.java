...
public class PirController {
    ...
    public BaseResultEntity pirSubmitTask(@RequestBody BaseJsonParam<DataPirReq> req) {
        if (req == null || req.getParam() == null) {
            return BaseResultEntity.failure(BaseResultEnum.LACK_OF_PARAM, "param");
        }
...
//            }
    ...
    @ApiOperation(value = "提交匿踪查询任务", httpMethod = "POST", consumes = MediaType.APPLICATION_JSON_VALUE)
    @RequestMapping("pirSubmitTaskMarket")
    public BaseResultEntity pirSubmitTaskMarket(String resourceId, String pirParam, String taskName) {
        // 查询条件
        ...
        return pirService.pirSubmitTaskMarket(param, pirParam);
    }
