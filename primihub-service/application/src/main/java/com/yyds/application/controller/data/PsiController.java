...
import com.yyds.biz.service.data.DataPsiService;
...
public class PsiController {
    ...
    public BaseResultEntity saveDataPsi(@RequestHeader("userId") Long userId,
        ...
        if (req.getOwnOrganId()==null||req.getOwnOrganId()==0L)
        ...
        if (req.getOtherOrganId()==null||req.getOtherOrganId()==0L)
            return BaseResultEntity.failure(BaseResultEnum.LACK_OF_PARAM,"otherOrganId");
        if (req.getOtherResourceId()==null||req.getOtherResourceId()==0L)
    ...
    public BaseResultEntity getPsiResourceDataList(DataResourceReq req,
                                                   @RequestHeader("organId") Long ownOrganId,
                                                   Long organId){
        if (organId==null||organId==0L)
            return BaseResultEntity.failure(BaseResultEnum.LACK_OF_PARAM,"organId");
        return dataPsiService.getPsiResourceAllocationList(req,organId,ownOrganId);
    }
