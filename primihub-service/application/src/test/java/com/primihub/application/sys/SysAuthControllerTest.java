        ...
        this.mockMvc.perform(get("/auth/getAuthTree"))
                ...
                .andDo(document("getAuthTree",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("result.sysAuthRootList[].children[].*").optional().description("上述描述"),
                                fieldWithPath("result.sysAuthRootList[].children[].children[].*").optional().description("上述描述"),
                                fieldWithPath("result.sysAuthRootList[].children[].children[].children[].*").optional().description("上述描述"),
