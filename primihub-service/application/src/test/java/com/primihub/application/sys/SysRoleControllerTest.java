        ...
        this.mockMvc.perform(get("/role/getRoleAuthTree")
                ...
                .andDo(document("getRoleAuthTree",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("result.roleAuthRootList[].children[].*").optional().description("上述描述"),
                                fieldWithPath("result.roleAuthRootList[].children[].children[].*").optional().description("上述描述"),
                                fieldWithPath("result.roleAuthRootList[].children[].children[].children[].*").optional().description("上述描述"),
                                fieldWithPath("extra").description("额外信息")
                        )
                ));
    }
