...
public enum ModelTypeEnum {
    ...
    REGRESSION_BINARY(6,"nn-回归",1,DataConstant.FREEMARKER_PYTHON_HOMO_NN_BINARY_PATH),
    CLASSIFICATION_BINARY(7,"nn-分类",1,DataConstant.FREEMARKER_PYTHON_HOMO_NN_BINARY_PATH),
    ;
