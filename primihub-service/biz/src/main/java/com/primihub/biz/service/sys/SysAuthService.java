...
public class SysAuthService {
    ...
    public BaseResultEntity generateAllAuth(){
        String[][] authArray=new String[][]{
                ...
                {"项目详情","ProjectDetail","4","Project","/project/getProjectDetails","1","1"},
                ...
                {"模型详情","ModelDetail","4","ModelList","/model/getdatamodel","1","1"},
                ...
                {"资源详情","ResourceDetail","4","ResourceMenu","/resource/getdataresource","1","1"},
