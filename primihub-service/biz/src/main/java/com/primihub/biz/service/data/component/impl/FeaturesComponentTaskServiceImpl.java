...
@Service("featuresComponentTaskServiceImpl")
public class FeaturesComponentTaskServiceImpl extends BaseComponentServiceImpl implements ComponentTaskService {
    @Autowired
