...
public class ResourceSecondaryDruidDataSourceWrapper extends DruidDataSource implements InitializingBean {
    ...
    private String url;
    @NacosValue(value="${spring.datasource.druid.resourceSecondary.username}",autoRefreshed = true)
    private String username;
    @NacosValue(value="${spring.datasource.druid.resourceSecondary.password}",autoRefreshed = true)
    private String password;
    @NacosValue(value="${spring.datasource.druid.resourceSecondary.driver-class-name}",autoRefreshed = true)
    private String driverClassName;
    @NacosValue(value="${spring.datasource.druid.resourceSecondary.connection-properties}",autoRefreshed = true)
    private String connectionProperties;
    @NacosValue(value="${spring.datasource.druid.resourceSecondary.filter.config.enabled}",autoRefreshed = true)
